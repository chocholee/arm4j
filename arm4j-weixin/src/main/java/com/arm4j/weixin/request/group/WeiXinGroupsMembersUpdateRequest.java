...
public class WeiXinGroupsMembersUpdateRequest {

    public static void request(String accessToken, String openId, Integer toGroupId) throws WeiXinRequestException {
        Map<String, Object> bodyMap = new HashMap<>();
        bodyMap.put("openid", openId);
        bodyMap.put("to_groupid", toGroupId);

        // 发送请求
        String result = WeiXinCoreManagement.getInstance().get(WeiXinToken.GROUPS_MEMBERS_UPDATE)
                .createConn()
                .connect(
