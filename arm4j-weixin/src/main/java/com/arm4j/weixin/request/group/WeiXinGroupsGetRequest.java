...
public class WeiXinGroupsGetRequest {

    public static List<GroupEntity> request(String accessToken) throws WeiXinRequestException {
        // 发送请求
        String result = WeiXinCoreManagement.getInstance().get(WeiXinToken.GROUPS_GET)
                .createConn()
                .connect(
        ...
        if (!StringUtils.isEmpty(result)) {
            ...
            if (!resultJSON.containsKey("errcode")) {
                return JSON.parseArray(resultJSON.getString("groups"), GroupEntity.class);
            } else {
